...
class Person
{
    public $type = "persona";
    /**
     * Identificador de la persona, Per exemple: DNI, NIE, etc...
     * @var
     */
    public $personalId;

    /**
     * Nom d'una persona ex: Pepito, Paco.
     * @var
     */
    public $givenName;
    /**
     * Primer cognom de la persona, si sera obligat
     * @var
     */
    public $sn1;
    /**
     * Segon cognom de la persona, que no será obligat
     * @var
     */
    public $sn2;

    /**
     * Email per contactar amb la persona
     * @var
     */
    public $email;
